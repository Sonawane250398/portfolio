...
export default function Skills({ pageLayout }: SkillsProps) {
  ...
  return (
    <section
      className={`relative z-10 px-4 py-24 min-[769px]:px-6 lg:px-12 ${
        pageLayout
          ? 'bg-transparent'
        ...
        >
          {skills.map((skillGroup, index) => (
            <motion.div
              ...
              className="group rounded-2xl border border-slate-200/80 bg-white/80 p-5 transition-all duration-300 hover:border-emerald-500/30 min-[769px]:p-8 dark:border-white/10 dark:bg-white/[0.02] dark:hover:border-emerald-500/20 dark:hover:bg-white/[0.04]"
            >
              <div className="mb-6 flex items-center gap-4">
                ...
                <h3 className="text-lg font-bold tracking-tight text-slate-900 min-[769px]:text-xl dark:text-white">
                  {skillGroup.category}
                </h3>
              </div>
